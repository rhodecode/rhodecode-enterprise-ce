...
class Repository(Base, BaseModel):
    ...
    #NOTE this is required for this migration to work
    def update_commit_cache(self, cs_cache=None):
        """
        ...
        if cs_cache is None:
            ...
            # Note: Using always the empty commit here in case we are
            # upgrading towards version 3.0 and above. Reason is that in this
            # case the vcsclient connection is not available and things
            # would explode here.
