...
class CacheInvalidation(Base, BaseModel):
    ...
    cache_key = Column("cache_key", String(None), nullable=True, unique=None, default=None)
    cache_args = Column("cache_args", String(None), nullable=True, unique=None, default=None)
