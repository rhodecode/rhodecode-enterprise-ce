...
def upgrade(migrate_engine):
    ...
    #add column
    ldap_dn = Column("ldap_dn", String(length=255, convert_unicode=False, ), nullable=True, unique=None, default=None)
    ldap_dn.create(User().__table__)

    api_key = Column("api_key", String(length=255, convert_unicode=False, ), nullable=True, unique=None, default=None)
