...
class RhodeCodeSetting(Base):
    ...
    app_settings_name = Column("app_settings_name", String(length=None, convert_unicode=False, ), nullable=True, unique=None, default=None)
    app_settings_value = Column("app_settings_value", String(length=None, convert_unicode=False, ), nullable=True, unique=None, default=None)
...
class RhodeCodeUi(Base):
    ...
    ui_section = Column("ui_section", String(length=None, convert_unicode=False, ), nullable=True, unique=None, default=None)
    ui_key = Column("ui_key", String(length=None, convert_unicode=False, ), nullable=True, unique=None, default=None)
    ui_value = Column("ui_value", String(length=None, convert_unicode=False, ), nullable=True, unique=None, default=None)
...
class User(Base):
    ...
    username = Column("username", String(length=None, convert_unicode=False, ), nullable=True, unique=None, default=None)
    password = Column("password", String(length=None, convert_unicode=False, ), nullable=True, unique=None, default=None)
    active = Column("active", Boolean(), nullable=True, unique=None, default=None)
    admin = Column("admin", Boolean(), nullable=True, unique=None, default=False)
    name = Column("name", String(length=None, convert_unicode=False, ), nullable=True, unique=None, default=None)
    lastname = Column("lastname", String(length=None, convert_unicode=False, ), nullable=True, unique=None, default=None)
    email = Column("email", String(length=None, convert_unicode=False, ), nullable=True, unique=None, default=None)
...
class Repository(Base):
    ...
    repo_name = Column("repo_name", String(length=None, convert_unicode=False, ), nullable=False, unique=True, default=None)
    repo_type = Column("repo_type", String(length=None, convert_unicode=False, ), nullable=False, unique=False, default=None)
    user_id = Column("user_id", Integer(), ForeignKey(u'users.user_id'), nullable=False, unique=False, default=None)
    private = Column("private", Boolean(), nullable=True, unique=None, default=None)
    enable_statistics = Column("statistics", Boolean(), nullable=True, unique=None, default=True)
    description = Column("description", String(length=None, convert_unicode=False, ), nullable=True, unique=None, default=None)
...
class Permission(Base):
    ...
    permission_name = Column("permission_name", String(length=None, convert_unicode=False, ), nullable=True, unique=None, default=None)
    permission_longname = Column("permission_longname", String(length=None, convert_unicode=False, ), nullable=True, unique=None, default=None)
...
class CacheInvalidation(Base):
    ...
    cache_key = Column("cache_key", String(length=None, convert_unicode=False), nullable=True, unique=None, default=None)
    cache_args = Column("cache_args", String(length=None, convert_unicode=False), nullable=True, unique=None, default=None)
    ...
    def __repr__(self):
        return "<CacheKey('%s:%s')>" % (self.cache_id, self.cache_key)
